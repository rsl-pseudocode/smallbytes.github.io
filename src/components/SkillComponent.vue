<template>
  <section aria-labelledby="tech-stack-heading">
    <v-row justify="center">
      <v-col cols="12">
        <h2
          ...
          class="gradient-text text-h5 font-weight-bold mb-4 mt-4 position-relative d-inline-block"
        >
          Tech Stack
          <div
          :style="{
    ...
    <v-col cols="12">
      <v-sheet color="transparent" class="pa-3 overflow-visible position-relative">
        <v-row justify="center" class="mb-4" role="list">
          <v-col v-for="(skill, index) in skillIcons" :key="index" cols="auto" role="listitem">
            <v-tooltip :text="skill.name" location="top">
              <template #activator="{ props }">
                <button
                  ...
                  :aria-expanded="activeSkill === skill.name ? 'true' : 'false'"
                  :style="{
                    cursor: 'pointer',
                    padding: '0.5rem',
                    borderRadius: '50%',
                    ...
                    transform:
                      activeSkill === skill.name ? 'scale(1.2)' : 'scale(1)',
                    background:
          ...
          <div v-if="activeSkill">
            <v-sheet
              ...
              :style="{
                ...
                borderTop: '1px solid rgba(207, 142, 0, 0.2)',
              }"
            >
              <p
                class="text-body-1 text-center font-italic"
                :style="{ color: '#a0a0a0' }"
              >
                {{ skillIcons.find((s) => s.name === activeSkill)?.description }}
              </p>
            </v-sheet>
          </div>
        </v-expand-transition>
...
const skillIcons: Skill[] = [
  {
    ...
    `,
    description:
      'Modern, object-oriented language for building type-safe applications',
  },
  {
    name: '.Net',
    icon: `
      ...
      >
        ...
        <path d="M9.82,9A32,32,0,1,0,55,54.18Z" fill="#cf8e00" />
        <path
        ...
        <path
          ...
          fill="#fff"
        />
        <path d="M56,24.7H50.7V41H48.57V24.7H43.33V22.77H56Z" fill="#fff" />
      </svg>
    `,
    description:
      'Cross-platform framework for building enterprise-grade applications',
  },
  {
    name: 'React',
    icon: `
  ...
  },
  {
    ...
    `,
    description:
      'Comprehensive cloud platform offering over 200 services for building scalable applications',
  },
  {
    name: 'Azure',
    icon: `
    ...
    `,
    description:
      "Microsoft's cloud platform for deploying, managing, and scaling applications",
  },
]
</script>
